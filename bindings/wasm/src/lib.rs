...
use wickra_exchange_core::{
    ...
    OrderStatus, PaperExchange, ReplayExchange, SelfTradePrevention, Symbol, TimeInForce,
    TradePrint,
};
...
impl OrderRequest {
    ...
    #[wasm_bindgen(js_name = withTimeInForce)]
    pub fn with_time_in_force(&self, tif: &str) -> Result<OrderRequest, JsValue> {
    ...
    #[wasm_bindgen(js_name = withClientOrderId)]
    #[must_use]
    pub fn with_client_order_id(&self, id: &str) -> OrderRequest {
        Self {
    ...
    #[wasm_bindgen(js_name = reduceOnly)]
    #[must_use]
    pub fn reduce_only(&self) -> OrderRequest {
        Self {
    ...
    #[wasm_bindgen(js_name = postOnly)]
    #[must_use]
    pub fn post_only(&self) -> OrderRequest {
        Self {
    ...
    #[wasm_bindgen(js_name = withStp)]
    pub fn with_stp(&self, stp: &str) -> Result<OrderRequest, JsValue> {
